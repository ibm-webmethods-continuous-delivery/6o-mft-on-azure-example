#!/bin/bash
# Deploy ActiveTransfer Gateway 1 to Azure VM
# Run this script on the Gateway VM (10.1.0.4)
...
echo "=== ActiveTransfer Gateway 1 Deployment ==="
echo ""
...
echo ""
echo "To view logs:"
echo "  sudo docker logs at-gateway1 -f"
echo ""
